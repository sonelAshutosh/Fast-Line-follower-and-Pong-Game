...
//
    ...
    #define BATTERY_LOW_VOLTAGE_CUTOFF      6500000   // SIX POINT FIVE Volt: Should NOT change, until you know, what you are doing!
    const int adcCountToMicoVoltVolt = 2386;
